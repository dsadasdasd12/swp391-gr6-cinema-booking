...
(function () {
      ...
      showConfirmModal({
        ...
        onConfirm: function () {
          if (trigger.tagName === 'A' && trigger.getAttribute('href')) {
            ...
            if (nestedForm) nestedForm.submit();
          }
        }
      });
    });
  ...
  window.showConfirmModal = function (options) {
    ...
    if (options.type === 'danger') iconClass = 'bi-trash-fill';
    if (options.type === 'success') iconClass = 'bi-check-circle-fill';
    if (options.type === 'info') iconClass = 'bi-info-circle-fill';
