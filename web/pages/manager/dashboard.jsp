        ...
        <div class="admin-shell">
            <aside class="admin-sidebar">
                ...
                <nav class="admin-menu">
                    ...
                    <a href="${ctx}/manager/movie-assignments/branches">Gán phim</a>
                    <a href="${ctx}/manager/halls">Cài đặt chi nhánh</a>
            ...
            <main class="admin-main">
                ...
                <section class="admin-content">
                    ...
                    <div class="dashboard-grid">
                        ...
                        <a class="dashboard-card" href="${ctx}/manager/movie-assignments/branches">
                            <h3>Gán phim</h3>
