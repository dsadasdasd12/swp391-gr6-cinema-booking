...
<c:set var="pageTitle" value="Quản lý chi nhánh - RapViet Cinema" scope="request" />
...
<head>
    ...
    <link rel="stylesheet" href="${ctx}/assets/css/admin/branchmanagement.css?v=1">
</head>
        ...
        <main class="rv-admin-main">
            ...
            <script>
                function filterBranches() {
                    const keyword = document.getElementById("branchSearch").value.toLowerCase();
