<%--
    Rạp Việt CMS — 403 Forbidden Error Page
--%>
...
<head>
    ...
    <title>403 — Không có quyền truy cập | Rạp Việt CMS</title>
    <!-- Bootstrap Icons -->
...
<div class="error-card">
    ...
    <h1 style="font-size: 36px; font-weight: 800; color: var(--n-900); margin-bottom: var(--s-1);">403</h1>
    <h2 style="font-size: var(--text-md); font-weight: 700; color: var(--n-700); margin-bottom: var(--s-3);">KHÔNG CÓ QUYỀN TRUY CẬP</h2>
    <p style="color: var(--n-500); font-size: var(--text-base); line-height: 1.6; margin-bottom: var(--s-6);">
        Tài khoản của bạn không được cấp quyền hạn tương ứng để truy cập trang quản trị này. Vui lòng liên hệ với quản trị viên tối cao (Admin) để biết thêm chi tiết.
    </p>
    <div style="display: flex; gap: var(--s-3); justify-content: center;">
        ...
        <a href="${ctx}/logout" class="rv-btn rv-btn--ghost">
