...
/**
 * Filter kiểm tra quyền hạn (Authorization) dựa trên vai trò của người dùng
 * (Role-based access control - RBAC). Phân phối quyền truy cập tới các module:
 * - Admin: Toàn quyền - Branch Manager: Phim (chỉ xem), Báo cáo (chỉ xem chi
 * nhánh mình), Tài khoản khách hàng.
 */
@WebFilter("/admin/*")
