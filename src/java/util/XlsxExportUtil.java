...
/**
 * Tạo file XLSX tối giản (1 sheet) mà không cần Apache POI.
 * - Dùng inlineStr cho toàn bộ cell (đơn giản, đủ mở bằng Excel).
 *
    ...
    public static void writeSingleSheetXlsx(OutputStream out,
        ...
        if (rows != null) {
            for (List<String> r : rows) {
                if (r != null) dataCols = Math.max(dataCols, r.size());
            }
        }
