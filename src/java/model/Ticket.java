...
/**
 * View object for e-ticket display. QR data comes from dbo.BOOKINGS.qr_code. No
 * separate TICKETS table exists in schema.
 *
 * @author LONG
 */
public class Ticket {
    ...
    public void setTicketUuid(String u) {
        this.ticketUuid = u;
    }
    ...
    public void setQrCodeBase64(String q) {
        this.qrCodeBase64 = q;
    }
    ...
    public void setLastUpdate(LocalDateTime t) {
        this.lastUpdate = t;
    }
    ...
    public void setShowtimeStart(String s) {
        this.showtimeStart = s;
    }
    ...
    public void setBookingStatus(String s) {
    ...
    public String getStatusBadgeClass() {
        if ("ISSUED".equals(ticketStatus)) {
            return "success";
        }
        if ("USED".equals(ticketStatus)) {
            return "secondary";
        }
        if ("PENDING_MANUAL".equals(ticketStatus)) {
            return "danger";
        }
        return "secondary";
    }
