...
public class ManagedUser extends User {
    ...
    /** Chuỗi ngày tạo cho trang khách hàng (tránh fmt:parseDate trên LocalDateTime). */
    ...
    public void setCreatedAtLabel(String createdAtLabel) { this.createdAtLabel = createdAtLabel; }
}
